...
{
    /// <summary> A class representing the Apple data model. </summary>
    public partial class AppleData : Resource
    {
        /// <summary> Initializes a new instance of AppleData. </summary>
        public AppleData()
        {
        ...
        internal AppleData(ResourceIdentifier id, string name, ResourceType type, PolicyType? policyType, string mode, string displayName, string description, object policyRule, object metadata, IDictionary<string, ParameterDefinitionsValue> parameters) : base(id, name, type)
        {
