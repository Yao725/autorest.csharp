...
{
    public partial class AppleData : IUtf8JsonSerializable
    {
        ...
        internal static AppleData DeserializeAppleData(JsonElement element)
        {
            ...
            return new AppleData(id, name, type, Optional.ToNullable(policyType), mode.Value, displayName.Value, description.Value, policyRule.Value, metadata.Value, Optional.ToDictionary(parameters));
        }
    }
}
