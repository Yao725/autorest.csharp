...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class SecretUpdateOperation : Operation<Secret>, IOperationSource<Secret>
    {
        ...
        internal SecretUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Secret>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "SecretUpdateOperation");
