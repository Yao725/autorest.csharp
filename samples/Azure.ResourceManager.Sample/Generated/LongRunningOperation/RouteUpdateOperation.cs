...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class RouteUpdateOperation : Operation<Route>, IOperationSource<Route>
    {
        private readonly OperationInternals<Route> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of RouteUpdateOperation for mocking. </summary>
