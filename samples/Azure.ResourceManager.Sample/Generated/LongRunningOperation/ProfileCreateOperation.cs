...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class ProfileCreateOperation : Operation<Profile>, IOperationSource<Profile>
    {
        private readonly OperationInternals<Profile> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ProfileCreateOperation for mocking. </summary>
        protected ProfileCreateOperation()
        {
        }

        internal ProfileCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Profile>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ProfileCreateOperation");
