...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class AFDOriginCreateOperation : Operation<AFDOrigin>, IOperationSource<AFDOrigin>
    {
        private readonly OperationInternals<AFDOrigin> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of AFDOriginCreateOperation for mocking. </summary>
        protected AFDOriginCreateOperation()
        {
        }

        internal AFDOriginCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AFDOrigin>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AFDOriginCreateOperation");
