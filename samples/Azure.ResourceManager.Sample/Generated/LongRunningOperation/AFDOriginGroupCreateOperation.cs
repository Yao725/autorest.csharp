...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class AFDOriginGroupCreateOperation : Operation<AFDOriginGroup>, IOperationSource<AFDOriginGroup>
    {
        private readonly OperationInternals<AFDOriginGroup> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of AFDOriginGroupCreateOperation for mocking. </summary>
        protected AFDOriginGroupCreateOperation()
        {
        }

        internal AFDOriginGroupCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AFDOriginGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AFDOriginGroupCreateOperation");
