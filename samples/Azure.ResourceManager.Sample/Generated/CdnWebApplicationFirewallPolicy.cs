...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class CdnWebApplicationFirewallPolicy : ArmResource
    {
        ...
        public async virtual Task<PolicyUpdateOperation> UpdateAsync(CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.UpdateAsync(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters, cancellationToken).ConfigureAwait(false);
                var operation = new PolicyUpdateOperation(this, _clientDiagnostics, Pipeline, _restClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual PolicyUpdateOperation Update(CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Update(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters, cancellationToken);
                var operation = new PolicyUpdateOperation(this, _clientDiagnostics, Pipeline, _restClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
