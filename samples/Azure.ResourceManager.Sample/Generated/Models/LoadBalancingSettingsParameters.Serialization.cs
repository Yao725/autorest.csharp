...
{
    public partial class LoadBalancingSettingsParameters : IUtf8JsonSerializable
    {
        ...
        internal static LoadBalancingSettingsParameters DeserializeLoadBalancingSettingsParameters(JsonElement element)
        {
            ...
            return new LoadBalancingSettingsParameters(Optional.ToNullable(sampleSize), Optional.ToNullable(successfulSamplesRequired), Optional.ToNullable(additionalLatencyInMilliseconds));
        }
    }
}
