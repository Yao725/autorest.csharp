...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    public partial class DeliveryRule
    {
        ...
        public DeliveryRule(int order, IEnumerable<DeliveryRuleOperation> actions)
        {
            if (actions == null)
            {
        ...
        /// <param name="actions"> A list of actions that are executed when all the conditions of a rule are satisfied. </param>
        internal DeliveryRule(string name, int order, IList<DeliveryRuleCondition> conditions, IList<DeliveryRuleOperation> actions)
        {
            Name = name;
            Order = order;
