...
{
    public partial class UrlFileNameMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static UrlFileNameMatchConditionParameters DeserializeUrlFileNameMatchConditionParameters(JsonElement element)
        {
            string odataType = default;
            UrlFileNameOperator @operator = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    @operator = new UrlFileNameOperator(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlFileNameMatchConditionParameters(odataType, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
