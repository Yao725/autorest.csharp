...
namespace Azure.ResourceManager.Sample.Models
{
    ...
    internal partial class OriginGroupListResult
    {
        ...
        {
            Value = new ChangeTrackingList<OriginGroupData>();
        }
        ...
        internal OriginGroupListResult(IReadOnlyList<OriginGroupData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<OriginGroupData> Value { get; }
