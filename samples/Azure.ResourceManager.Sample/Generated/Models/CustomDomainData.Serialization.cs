...
namespace Azure.ResourceManager.Sample
{
    public partial class CustomDomainData : IUtf8JsonSerializable
    {
        ...
        internal static CustomDomainData DeserializeCustomDomainData(JsonElement element)
        {
            ...
            return new CustomDomainData(id, name, type, systemData.Value, hostName.Value, Optional.ToNullable(resourceState), Optional.ToNullable(customHttpsProvisioningState), Optional.ToNullable(customHttpsProvisioningSubstate), validationData.Value, provisioningState.Value);
        }
    }
}
