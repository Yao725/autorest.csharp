...
{
    public partial class RequestBodyMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static RequestBodyMatchConditionParameters DeserializeRequestBodyMatchConditionParameters(JsonElement element)
        {
            ...
            return new RequestBodyMatchConditionParameters(odataType, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
