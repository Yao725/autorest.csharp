...
{
    public partial class RuleSetData : IUtf8JsonSerializable
    {
        ...
        internal static RuleSetData DeserializeRuleSetData(JsonElement element)
        {
            ...
            return new RuleSetData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(deploymentStatus));
        }
    }
}
