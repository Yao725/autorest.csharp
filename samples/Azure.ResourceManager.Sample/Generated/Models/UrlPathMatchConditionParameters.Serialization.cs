...
{
    public partial class UrlPathMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static UrlPathMatchConditionParameters DeserializeUrlPathMatchConditionParameters(JsonElement element)
        {
            ...
            return new UrlPathMatchConditionParameters(odataType, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
