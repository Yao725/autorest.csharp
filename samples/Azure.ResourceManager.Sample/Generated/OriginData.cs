...
{
    /// <summary> A class representing the Origin data model. </summary>
    public partial class OriginData : ProxyResource
    {
        /// <summary> Initializes a new instance of OriginData. </summary>
        public OriginData()
        {
        }
