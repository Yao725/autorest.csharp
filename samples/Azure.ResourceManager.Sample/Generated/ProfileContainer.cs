...
namespace Azure.ResourceManager.Sample
{
    ...
    public partial class ProfileContainer : ArmContainer
    {
        ...
        public virtual ProfileCreateOperation CreateOrUpdate(string profileName, ProfileData profile, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Create(Id.ResourceGroupName, profileName, profile, cancellationToken);
                var operation = new ProfileCreateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateRequest(Id.ResourceGroupName, profileName, profile).Request, response);
        ...
        public async virtual Task<ProfileCreateOperation> CreateOrUpdateAsync(string profileName, ProfileData profile, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.CreateAsync(Id.ResourceGroupName, profileName, profile, cancellationToken).ConfigureAwait(false);
                var operation = new ProfileCreateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateRequest(Id.ResourceGroupName, profileName, profile).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<Profile> Get(string profileName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var response = _restClient.Get(Id.ResourceGroupName, profileName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<Profile>> GetAsync(string profileName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var response = await _restClient.GetAsync(Id.ResourceGroupName, profileName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        // Builders.
        // public ArmBuilder<ResourceIdentifier, Profile, ProfileData> Construct() { }
    }
}
